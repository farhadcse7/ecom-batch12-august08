                            ...
                            <main id="gallery">
                                ...
                                <div class="images">
                                    ...
                                    @foreach($product->productImages as $productImage)
                                        <img src="{{asset($productImage->image)}}" id="current" alt="#">
                                    @endforeach
                                </div>
                            </main>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category"><i class="lni lni-tag"></i>
                                Category:<a href="javascript:void(0)">{{$product->category->name}}</a>
                            </p>
                            <p class="category"><i class="lni lni-tag"></i>
                                Brand:<a href="javascript:void(0)">{{$product->brand->name}}</a>
                            </p>

                            <h3 class="price">TK. {{$product->selling_price}}
                                <span> TK. {{$product->regular_price}}</span></h3>
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-4 col-md-4 col-12">
                                            <div class="button cart-button">
                                                <button type="submit" class="btn" style="width: 100%;">Add to Cart
                                                </button>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-12">
