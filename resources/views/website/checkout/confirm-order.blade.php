                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="single-form form-default">
                                                ...
                                                <div class="form-input form">
                                                    <textarea class="pt-2" style="height: 80px" name="delivery_address" placeholder="Delivery Address"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="single-checkbox checkbox-style-3">
                                                <input type="radio" name="payment_method" checked value="Cash" id="checkbox-3">
                                                <label for="checkbox-3">Cash on Delivery</label>
                                            </div>
                                            <div class="single-checkbox checkbox-style-3">
                                                <input type="radio" name="payment_method" checked value="Online" id="checkbox-4">
