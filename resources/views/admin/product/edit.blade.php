                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('product.update', ['id'=>$product->id])}}" method="POST"
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" name="name" value="{{$product->name}}" id="categoryName" placeholder="Product Name"
                                       type="text">
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" name="code" id="categoryName" value="{{$product->code}}" placeholder="Product Code"
                                       type="text">
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <input class="form-control" name="regular_price" value="{{$product->regular_price}}" placeholder="regular price" id="image" type="number"/>
                                    <input class="form-control" name="selling_price" value="{{$product->selling_price}}" placeholder="selling price" id="image" type="number"/>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" name="stock_amount" value="{{$product->stock_amount}}" placeholder="Stock Amount" id="image" type="number"/>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="meta_title" id="description"
                                          placeholder="Short Description">{{$product->meta_title}}</textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="meta_description" id="description"
                                          placeholder="Short Description">{{$product->meta_description}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <label><input name="status" {{$product->status ==1 ? 'checked':''}} type="radio" value="1"/>Published</label>
                                <label><input name="status" {{$product->status ==0 ? 'checked':''}} type="radio" value="0"/>Unpublished</label>
                            </div>
                        </div>
